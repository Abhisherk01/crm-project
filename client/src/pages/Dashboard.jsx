...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Cleanup: cancels the pending timer AND any request still in flight,
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          to="/new"
          className="rounded-lg bg-yellow-400 px-4 py-2 text-center font-semibold text-black transition-colors hover:bg-yellow-300"
        >
          + New Ticket
        </Link>
      </div>
            ...
            <tbody className="divide-y divide-zinc-800">
              {tickets.map((ticket) => (
                <tr key={ticket.ticket_id} className="hover:bg-zinc-800/50">
                  ...
                  <td className="hidden px-4 py-3 text-zinc-100 md:table-cell">
